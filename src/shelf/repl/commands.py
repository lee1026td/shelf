...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("track", "Promote a topic to a tracked topic", 3),
    SlashCommand("sources", "Review the source universe", 3),
    SlashCommand("compile", "Compile a cited brief / landscape", 3),
    SlashCommand("search", "Search the library", 3),
    SlashCommand("watch", "Manage watched sources", 4),
    SlashCommand("inbox", "Skim newly collected items", 4),
